 ...
 */
final class Version20210204220224 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_845CA2C1BFCDF877 ON order_details (my_order_id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_845CA2C1BFCDF877 ON order_details');
